...
from detector.east.east.models import EAST
from detector.east.east.utils import get_rotate_mat
from PIL import Image, ImageDraw
from torchvision import transforms
from detector.east.settings import Arguments
...
def detector(opt, model, device):
    ...
    if boxes is not None:
        for box in boxes:
            ...
            x_max, y_max = int(box[4]), int(box[5])
